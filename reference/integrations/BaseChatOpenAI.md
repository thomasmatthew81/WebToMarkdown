...
> A collection of 1 web pages converted to Markdown format. Generated on 2025-11-15 15:03:23.

## Converted Web Pages

### BaseChatOpenAI | LangChain Reference

**Source:** https://reference.langchain.com/python/integrations/langchain_openai/BaseChatOpenAI/

Skip to content 

[ ](https://github.com/langchain-ai/docs/tree/main/reference/python/docs/integrations/langchain_openai/BaseChatOpenAI.md "Edit this page")
...
Bases: `[BaseChatModel](../../../langchain_core/language_models/#langchain_core.language_models.BaseChatModel "<code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>            <span class="doc doc-object-name doc-class-name">BaseChatModel</span> \(<code>langchain_core.language_models.chat_models.BaseChatModel</code>\)")`
...
####  `` max_tokens `class-attribute` `instance-attribute` ¶
    ...
    max_tokens: [int](https://docs.python.org/3/library/functions.html#int) | None = [Field](https://docs.pydantic.dev/latest/api/fields/#pydantic.fields.Field "<code>pydantic.Field</code>")(default=None)
...
####  `` with_structured_output ¶
    ...
    with_structured_output(
        ...
        *,
        method: [Literal](https://docs.python.org/3/library/typing.html#typing.Literal "<code>typing.Literal</code>")[
            "function_calling", "json_mode", "json_schema"
        ] = "function_calling",
        include_raw: [bool](https://docs.python.org/3/library/functions.html#bool) = False,
        strict: [bool](https://docs.python.org/3/library/functions.html#bool) | None = None,
        tools: [list](https://docs.python.org/3/library/stdtypes.html#list) | None = None,
        **kwargs: [Any](https://docs.python.org/3/library/typing.html#typing.Any "<code>typing.Any</code>"),
    ) -> [Runnable](../../../langchain_core/runnables/#langchain_core.runnables.base.Runnable "<code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>            <span class="doc doc-object-name doc-class-name">langchain_core.runnables.base.Runnable</span> \(<code>langchain_core.runnables.Runnable</code>\)")[[LanguageModelInput](../../../langchain_core/language_models/#langchain_core.language_models.base.LanguageModelInput "<code class="doc-symbol doc-symbol-heading doc-symbol-attribute"></code>            <span class="doc doc-object-name doc-attribute-name">LanguageModelInput</span>
...
`method` |  The method for steering model generation, one of:
  ...
  * `'json_schema'`: Uses OpenAI's [Structured Output API](https://platform.openai.com/docs/guides/structured-outputs)
...
**TYPE:** `[Literal](https://docs.python.org/3/library/typing.html#typing.Literal "<code>typing.Literal</code>")['function_calling', 'json_mode', 'json_schema']` **DEFAULT:** `'function_calling'`  
...
**TYPE:** `[list](https://docs.python.org/3/library/stdtypes.html#list) | None` **DEFAULT:** `None`  
